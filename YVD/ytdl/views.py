...
def download_video(request):
    ...
    if form.is_valid():
        ...
        if not re.match(regex,video_url):
            print('nhi hoa')
            return HttpResponse("<h1 style=\"color:red; background:#ff000059; text-align:center;\">This URL is incorrect or the video is not downloadable!!</h1> <p style=\"text-align:center; background:lightgray;\">Please enter a valid URL</p>")
